...
<input type='hidden' name='outputNameLengthMax' value='12'>
...
if(!empty($_POST)){
	$inputArray = array(
		...
		"outputNameLengthMax" => $_POST["outputNameLengthMax"],
	...
	print("かな／カナ／漢字:".$outputArray["hiraganaName"]." ／ ".$outputArray["katakanaName"]." ／ <span id='kanjiName'>".$outputArray["kanjiName"]."</span><hr>\n");
	print("漢字意味:\n");
