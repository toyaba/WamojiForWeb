...
<html lang="{{$language_code}}">
  <head>
    ...
    <title>@lang('kanjiSelect.title') | Wamojiya</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('/assets/css/kanjiSelect.css') }}">
    <script>
  ...
  <body class="drawer drawer--top drawer--navbarTopGutter">
    <div class="container" id="top">
      ...
      <main class="main" role="main">
        <div class="inner">
          <h1 class="tc">@lang('kanjiSelect.main_title')</h1>
          <p class="tc-l">@lang('kanjiSelect.description')</p>
            ...
            <ul class="list list-gender">
              <li>
                <label for="gender-m" onclick="">
                  <input id="gender-m" type="radio" name="gender" value="m">@lang('kanjiSelect.gender_male')
                </label>
              </li>
              <li>
                <label for="gender-f" onclick="">
                  <input id="gender-f" type="radio" name="gender" value="f">@lang('kanjiSelect.gender_female')
                </label>
              </li>
              <li>
                <label for="gender-n" onclick="">
                  <input id="gender-n" type="radio" name="gender" value="">@lang('kanjiSelect.gender_unanswered')
                </label>
              </li>
            </ul>
            <ul class="list flex justify-center list-switch__type" id="js-switchType">
              <li><a class="current" id="select_type_name" href="#type-name">@lang('kanjiSelect.type_name')</a></li>
              <li><a id="select_type_kana" href="#type-kana">@lang('kanjiSelect.type_kana')</a></li>
            </ul>
            <div class="form-group__convert" id="type-convert">
              <div class="db" id="type-name">
                <div class="flex justify-center">
                  <input class="input-convert__text" type="text" name="c_name" placeholder="@lang('kanjiSelect.placeholder_name')" maxlength="20" inputmode="latin">
                  ...
                  <input class="btn-convert" type="submit" value="@lang('kanjiSelect.button_convert')">
                </div>
                <div class="flex justify-center">
              ...
              <div class="dn" id="type-kana">
                <div class="flex justify-center">
                  <input class="input-convert__text" type="text" name="c_name" placeholder="@lang('kanjiSelect.placeholder_kana')" maxlength="20" inputmode="katakana">
          ...
          <p class="tc"><small class="gray">@lang('kanjiSelect.convert_comment', ['length' => $max_length])</small></p>
          ...
          <div class="dn" id="js-result">
            <h1 class="tc">@lang('kanjiSelect.convert_result')</h1>
            <p class="tc">@lang('kanjiSelect.wamoji_result')</p>
            <ul class="list flex-l justify-between-l list-wamoji">
              <li class="result-hiragana__value">
                <span>@lang('kanjiSelect.hiragana')</span>
                <strong class="wf-ipaexmincho"></strong>
                <input type="hidden" name="hiragana" value="">
              </li>
              <li class="result-katakana__value">
                <span>@lang('kanjiSelect.katakana')</span>
                <strong class="wf-ipaexmincho"></strong>
                <input type="hidden" name="katakana" value="">
              </li>
              <li class="result-kanji__value">
                <span>@lang('kanjiSelect.kanji')</span>
                <strong class="wf-ipaexmincho"></strong>
                <input type="hidden" name="kanji" value="">
              </li>
            </ul>
            <div class="select-kanjilist">
              <p class="tc mt0">@lang('kanjiSelect.select_kanji')</p>
              <div class="flex flex-wrap" id="js-selectKanjiList">
              </div>
            </div>
            <p class="tc"><a class="btn btn-forward" href="javascript:void(0);">@lang('kanjiSelect.button_next')</a></p>
          </div>
          <div class="tc"><a class="btn btn-back" href="javascript:void(0);">@lang('kanjiSelect.button_back')</a></div>
        </div>
      </main>
      @include('footer')
      ...
      <script src="{{ asset('/assets/js/kanjiSelect.js') }}"></script>
